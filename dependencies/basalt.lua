...
local ab=da("basaltEvent")local bb=da("utils").getValueFromXML
return
function(cb)local db="Timer"local _c=0;local ac=0;local bc=0;local cc
local dc=ab()local _d=false
